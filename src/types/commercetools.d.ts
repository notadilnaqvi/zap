...
export type Cart = {
	...
	origin?: CartOrigin;
	totalLineItemQuantity?: Maybe<number>;
...
export type CustomFieldsType = {
	promotional_sms: Scalars['Boolean'];
	promotional_email: Scalars['Boolean'];
	weekly_in_store_specials: Scalars['Boolean'];
	discount_sale_events: Scalars['Boolean'];
	special_offers: Scalars['Boolean'];
	catalogue_offer_highlights: Scalars['Boolean'];
	printed_catalogs: Scalars['Boolean'];
	digital_catalogues: Scalars['Boolean'];
	...
	/** Custom fields are returned as a list instead of an object structure. */
	customFieldList?: Maybe<Array<CustomField>>;
	/** Custom fields show up as name-value inside the fields object inside custom */
...
export type MutationUpdateCustomerArgs = {
	version: Scalars['Long'];
	actions: Array<ChangeCustomerEmail>;
	storeKey?: Maybe<Scalars['KeyReferenceInput']>;
	id?: Maybe<Scalars['String']>;
	key?: Maybe<Scalars['String']>;
};
