...
export type CustomSuggestTokenizerProductSearch =
...
export type WhitespaceSuggestTokenizerProductSearch =
	SuggestTokenizerProductSearch & {
...
export type CreateMyCartMutation = {
	__typename?: 'Mutation';
	createMyCart?: { __typename?: 'Cart'; id: string; version: any } | null;
};
...
export type UpdateMyCartMutation = {
	__typename?: 'Mutation';
	updateMyCart?: { __typename?: 'Cart'; id: string; version: any } | null;
};
...
export const CreateMyCartDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'createMyCart' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: {
...
>;
export const UpdateMyCartDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'updateMyCart' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: {
					...
					type: {
						...
						type: {
							...
							type: {
								...
								type: {
									kind: 'NamedType',
									name: { kind: 'Name', value: 'MyCartUpdateAction' },
								},
							},
						},
					},
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'activeCart' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'id' } },
